...
const ProductFullDetail = props => {
    const tabs = ['Description', 'Attributes'];
    const { product } = props;
    ...
    const cartActionContent = isSupportedProductType ? (
        <section className={classes.actButton}>
            ...
            >
                <ShoppingBag />
                <p className={classes.buttonText}>{cartCallToActionText}</p>
            </Button>
        </section>
    ) : (
    ...
    return (
        <Fragment>
            ...
            >
                ...
                <section className={classes.shippingSection}>
                    <CmsBlock
                        identifiers={'shipping-block'}
                        classes={{
                            block: classes.shippingBlock,
                            content: classes.shippingContent,
                ...
                <section className={classes.tabs}>
                    <Tabs tabsTitle={tabs}>
                        <Tab tabTitle={tabs[0]}>{shortDescription}</Tab>
                        <Tab tabTitle={tabs[1]}>
                            <CustomAttributes
